		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (10)",
									"targetURL": "#examexprogram10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram10-display": {
								"semanticObject": "examexprogram10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram10",
									"url": sap.ui.require.toUrl("exam/exprogram10")
								}
							}
						}
					}
