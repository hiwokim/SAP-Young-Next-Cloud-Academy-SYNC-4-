		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ODataCRUD",
									"targetURL": "#opdataproject1013-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opdataproject1013-display": {
								"semanticObject": "opdataproject1013",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opdata.project1013",
									"url": sap.ui.require.toUrl("opdata/project1013")
								}
							}
						}
					}
